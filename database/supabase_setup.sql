-- ============================================================
-- SecretarIA — Setup completo do Supabase
...
-- ── FUNÇÃO: incrementar contadores de mensagens ────────────
...
-- ── HABILITAR REALTIME ────────────────────────────────────
-- Execute no SQL Editor do Supabase para habilitar realtime nas tabelas:
...
-- Habilita segurança por usuário. Ajuste as políticas conforme sua necessidade.
...
-- Política simples: usuário autenticado pode ver e editar tudo
-- (Para uma clínica pequena isso é suficiente; refine se precisar de multiusuário)
